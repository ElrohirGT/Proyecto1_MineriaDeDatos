...
Se puede ver que la correlación entre la diferencia de géneros y las ganancias es .
...
directors[order(directors$voteAvg, decreasing = TRUE),]
```
...
Haga los gráficos que necesite, histograma, diagrama de dispersión ¿Se asocian ciertos meses de lanzamiento con mejores ingresos?
